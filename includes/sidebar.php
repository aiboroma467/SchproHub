...
{               ?>  
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion">
                  <li class="no-padding"><a class="waves-effect waves-grey" href="#"><i class="material-icons"></i>Dashboard</a></li>
  ...
  <li class="no-padding"><a class="waves-effect waves-grey" href="emp-changepassword.php"><i class="material-icons"></i>Change Password</a></li>
                    <li class="no-padding">
                        <a class="collapsible-header waves-effect waves-grey"><i class="material-icons"></i>Project<i class="nav-drop-icon material-icons"></i></a>
                        <div class="collapsible-body">
                            <ul>
                                <li><a href="upload-project.php">Upload Project</a></li>
                                <li><a href="projecthistory.php">Project History</a></li>
								<!--<li><a href="leavehistory.php">Completed Projects </a></li>-->
                            </ul>
                        </div>
                    </li>
					
					<li class="no-padding">
                        <a class="collapsible-header waves-effect waves-grey"><i class="material-icons"></i>Job Description<i class="nav-drop-icon material-icons"></i></a>
                        <div class="collapsible-body">
                            <ul>
                                <li><a href="upload-project.php">New Job</a></li>
                                <li><a href="projecthistory.php">Pending Job</a></li>
								<li><a href="leavehistory.php">Completed Job </a></li>
                            </ul>
                        </div>
                    </li>
