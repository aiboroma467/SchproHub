...
$sql="INSERT INTO tblemployees(FirstName,LastName,EmailId,Password,Department,Phonenumber,Status) VALUES(:fname,:lname,:email,:password,:department,:mobileno,:status)";
...
if($lastInsertId)
{
$msg="Vendor record added Successfully";
}
else 
{
