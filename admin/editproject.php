...
$sql="update tblemployees set FirstName=:fname,LastName=:lname,Department=:department,Phonenumber=:mobileno where id=:eid";
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Admin | Update Project</title>
...
.succWrap{
  ...
  <?php include('includes/header.php');?>
   ...
   <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Update Project</div>
                    </div>
