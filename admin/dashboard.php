...
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$totcustomercount=$query->rowCount();
?>   
                                <span class="stats-counter"><span class="counter"><?php echo htmlentities($totcustomercount);?></span></span>
...
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$ongingpcount=$query->rowCount();
?>   
                                <span class="stats-counter"><span class="counter"><?php echo htmlentities($ongoingpcount);?></span></span>
